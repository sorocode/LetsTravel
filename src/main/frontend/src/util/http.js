...
const PLACE_TEXT_URL = "https://places.googleapis.com/v1/places:";
...
export const fetchSpots = async (searchTerm) => {
  try {
    const req = await axios.post(PLACE_TEXT_URL + `${searchTerm}`, {
      headers: {
